 ...
 * @author
 */
public class Empleados1 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (tipo == 1) {
            ...
            Dao d = new Dao();
            if (nomu.isEmpty() || cont.isEmpty() || confirm_password.isEmpty()) {
                        ...
                        if (cont.equals(confirm_password)) {
                            try {
                                ...
                                if (d.isEmailRegistered(nomu)) {
                                    ...
                                    Empleado a = new Empleado(id, sec, cant, nombre, nomu, cont, rol, d2);
            ...
            RequestDispatcher dispacher = request.getRequestDispatcher("NuevoEmpleado.jsp");
            dispacher.forward(request, response);
        } else {
