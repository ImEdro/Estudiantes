...
public class Equipos1 extends HttpServlet {
    ...
    public Equipos1() throws FileNotFoundException, URISyntaxException {
        e = new Equipos();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (tipo == 1) {
            ...
            try {
                ...
                Logger.getLogger(Equipos1.class.getName()).log(Level.SEVERE, null, ex);
            }
            if (e == null) {
            ...
            if (request.getParameter("nombre").length() != 0) {
                ...
                Aeronave a = null;
                try {
                    f = new Fabricantes().buscar(idfab);
                    a = new Aeronaves().buscar(idae);
                } catch (URISyntaxException ex) {
                    Logger.getLogger(Equipos1.class.getName()).log(Level.SEVERE, null, ex);
                }
